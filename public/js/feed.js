...
function addPost(userlink, username, date, post, likes, isLiked, isNewPost, id, overridePostContainer) {
    ...
    //     <div class='postLikes'>
    //         <div>
    //             <div class='heart " + heart + "' id='heart." + id + "' " + heartAction + "></div> <span class='likeNum'>Likes: <span id='like." + id + "'>" + likes + "</span></span>
    //         </div> "+ commentStructure +"</div>
    //     <div class='postComments'>
    //         <ul id='comments_" + id + "'> </ul>
